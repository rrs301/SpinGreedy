 ...
 //   int conditionn=HomePage.condition;
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
       // MobileAds.initialize((mContext), String.valueOf(R.string.Admob_App_Id));
            ...
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.earning_history_latout, null);
...
//            .into(customViewHolder.AppImage);
            Log.i("TaskName",feedItem.getTaskName());
            customViewHolder.TaskName.setText(Html.fromHtml(feedItem.getTaskName()));//+ ₹
            customViewHolder.TaskAmount.setText(Html.fromHtml("+"+feedItem.getTaskAmount()+" Coins"));
